...
console.log(a<b && c>b && a<c);          //  true
console.log(b>a && a>c && b<c);          // false
...
console.log(d<e || e<f || f>d);              // true
console.log(d>e || f<d || e>f);              // false
...
console.log(!(num1>num2 && num2>num3 && num3<num1));                // true
console.log(!(num1<num2 && num2<num3 && num3>num1));                //  false
